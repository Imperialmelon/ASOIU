...
flowchart LR
    ...
    click par1 href "https://mlp.fandom.com/wiki/My_Little_Pony_Friendship_is_Magic_Wiki" "переход для Режима" _blank;
    click par3 href "https://shrek.fandom.com/wiki/WikiShrek" "переход для Сост" _blank;
```